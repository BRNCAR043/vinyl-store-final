...
import { initializeApp } from "firebase/app"; //connect frontend and Firebase project
...
// Initialize Firebase
const app = initializeApp(firebaseConfig); //pass the configuration object so it can connect and intialize services
