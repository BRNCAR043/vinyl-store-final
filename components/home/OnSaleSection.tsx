      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-10">
          <div className="flex items-center gap-4 mb-2">
            <span className="vintage-tag">Sale</span>
            <div className="flex-1 h-px bg-gradient-to-r from-[#c9a86c]/30 to-transparent" />
          </div>
          <h2 className="text-4xl md:text-5xl font-bold section-heading heading-glow font-playfair">On Sale</h2>
          <p className="text-[#b8a08a] mt-2 font-lora italic">Handpicked deals on quality vinyl</p>
        </div>
